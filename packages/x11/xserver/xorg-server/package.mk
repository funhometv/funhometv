...
#enable-xvmc we haoyq at 2023/1/1
...
#fix sys/stropt.h ... we haoyq at 2023/1/9
  echo "fix sys/stropt.h"
  ls -l ${TOOLCHAIN}/${TARGET_NAME}/sysroot/usr/include/X11/Xtrans/Xtranslcl.c
  sed -i "s=# include <sys/stropts.h>=="  ${TOOLCHAIN}/${TARGET_NAME}/sysroot/usr/include/X11/Xtrans/Xtranslcl.c
  ls -l ${TOOLCHAIN}/${TARGET_NAME}/sysroot/usr/include/X11/Xtrans/Xtranslcl.c
}
...
post_makeinstall_target() {
  ...
  # removed same as the following , we haoyq @ 2023/1/1
  ...
  ### we haoyq remove it @ 2023/1/1, for we not using nvidia drivers.
  #if [ ! "$OPENGL" = "no" ]; then
