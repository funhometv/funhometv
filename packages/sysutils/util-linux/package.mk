...
#Can't exec "gtkdocize": No such file or directory at /fam/erichao/funhome.tv.4/build.FunHomeTV-Generic.x86_64-1.0.1/toolchain/share/autoconf/Autom4te/FileUtils.pm line 293.
export GTKDOCIZE=echo



#in order to add fdisk , we haoyq should use ncurses
                          #--without-ncurses \
...
post_makeinstall_target() {
  if [ "$SWAP_SUPPORT" = "yes" ]; then
    ...
    mkdir -p $INSTALL/usr/lib/funhometv
      ...
      #we haoyq changed to funhometv
      cp -PR $PKG_DIR/scripts/mount-swap $INSTALL/usr/lib/funhometv
